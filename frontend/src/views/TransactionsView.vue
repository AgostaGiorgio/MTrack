...
import { Landmark, CreditCard, ChevronRight, X } from 'lucide-vue-next'
...
const categoriesDB = ref([
  { name: 'Car', subs: ['Fuel', 'Parking', 'Maintenance'] },
  { name: 'Utilities', subs: ['Internet', 'Electricity', 'Water'] },
  { name: 'Dining', subs: [] },
  { name: 'Groceries', subs: [] },
])
...
<template>
  <div class="py-2 flex flex-col h-full">
    ...
    <header class="mb-6 flex justify-between items-end">
      <div>
        <p class="text-md text-brand-textMuted mt-1">May 2026 • {{ transactions.length }} operations</p>
      </div>
    </header>
        ...
        <div class="flex justify-between items-start">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-brand-background flex items-center justify-center flex-shrink-0">
              <Landmark class="w-5 h-5 text-brand-primary" />
            </div>
            <div>
    ...
    <Teleport to="body">
      ...
      <transition 
        enter-active-class="transition-transform duration-300 cubic-bezier(0.4, 0, 0.2, 1)"
        leave-active-class="transition-transform duration-300 cubic-bezier(0.4, 0, 0.2, 1)"
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="relative">
                ...
                <ChevronDown class="w-5 h-5 absolute right-4 top-4 text-brand-textMuted pointer-events-none" />
              </div>
            </div>
